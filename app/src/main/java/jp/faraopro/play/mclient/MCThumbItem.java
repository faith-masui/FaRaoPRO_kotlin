 ...
 * 
 */
public class MCThumbItem implements IMCItem, Parcelable {
	private String mId;
	...
	public static final Parcelable.Creator<MCThumbItem> CREATOR = new Parcelable.Creator<MCThumbItem>() {
		@Override
		public MCThumbItem createFromParcel(Parcel in) {
			return new MCThumbItem(in);
		}

		@Override
		public MCThumbItem[] newArray(int size) {
			return new MCThumbItem[size];
		}
	};
}
