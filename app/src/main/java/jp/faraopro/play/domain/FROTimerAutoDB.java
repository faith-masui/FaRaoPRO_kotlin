 ...
 * 
 */
public class FROTimerAutoDB implements ITimerDB {
	@SuppressWarnings("unused")
	private static final String TAG = FROTimerAutoDB.class.getSimpleName();
	@SuppressWarnings("unused")
	private static final boolean DEBUG = true;

	static final String TABLE_NAME = "TIMER_AUTO_TABLE";
	 ...
	 * @param database
	 */
	public FROTimerAutoDB(SQLiteDatabase database) {
	...
	public void deleteAll() {
		...
		database.execSQL(FRODBHelper.CREATE_TIMER_AUTO_TABLE_SQL);
	}
