 ...
 * 
 */
public class FROMusicHistoryDB implements IFROMusicInfoDB {
	private static final String TAG = FROMusicHistoryDB.class.getSimpleName();
	private static final boolean D = false;

	static final String TABLE_NAME = "MUSIC_HISTORY_TABLE";
	 ...
	 * @param database
	 */
	public FROMusicHistoryDB(SQLiteDatabase database) {
	...
	public void deleteAll() {
		...
		database.execSQL(FRODBHelper.CREATE_MUSIC_HISTORY_TABLE_SQL);
	}
