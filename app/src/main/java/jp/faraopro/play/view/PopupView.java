...
public class PopupView extends ImageView {
	...
	// 0xFF);
	private static final int BACKGROUND_COLOR = Color.parseColor("#8060AEF3");
	...
	private void setBitmap(View itemView) {
		Bitmap bitmap = Bitmap.createBitmap(itemView.getWidth(), itemView.getHeight(), DRAG_BITMAP_CONFIG);
